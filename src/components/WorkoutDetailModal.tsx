        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.summaryRow}>
            {workout.status === "completed" && (
              <>
                ...
                {workout.sensation && (
                  <View style={styles.summaryItem}>
                    {(workout.sensation === "Great" ||
                      workout.sensation === "Good") && (
                      <Zap size={18} color="#FFD700" />
                    )}
                    {workout.sensation === "Neutral" && (
                      <Smile size={18} color="#22C55E" />
                    )}
                    {(workout.sensation === "Hard" ||
                      workout.sensation === "Exhausted") && (
            ...
            {workout.status === "completed" && workout.notes && (
              <View
                style={[
                  ...
                  { backgroundColor: colors.card, borderColor: "#F1F5F9" },
                ]}
              >
                <View
                  style={{
            ...
            >
              ...
              {exercise.sets.map((set, sIdx) => (
                <View key={set.id} style={styles.setRow}>
                  <Text
                    style={[styles.setText, { color: colors.textSecondary }]}
                  >
                    Serie {sIdx + 1}
                  </Text>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          {workout.status === "completed" && onDoAgain && (
            <TouchableOpacity
              ...
              style={[
                styles.doAgainButton,
                { backgroundColor: colors.primary },
              ]}
            >
              <Dumbbell size={20} color={colors.background} />
              <Text
                style={[styles.doAgainButtonText, { color: colors.background }]}
              >
                Hacerlo de nuevo
              </Text>
