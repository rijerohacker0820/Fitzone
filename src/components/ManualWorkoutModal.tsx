    ...
    >
      <View style={{ flex: 1, backgroundColor: "#FFFFFF" }}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.toggleContainer}>
            <TouchableOpacity
              style={[
                styles.toggleButton,
                mode === "ai" && styles.activeToggle,
              ]}
              onPress={() => setMode("ai")}
            >
              <Sparkles
                size={18}
                color={mode === "ai" ? "#3B82F6" : "#94A3B8"}
              />
              <Text
                style={[
                  styles.toggleText,
                  mode === "ai" && styles.activeToggleText,
                ]}
              >
                Preguntar a IA
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.toggleButton,
                mode === "manual" && styles.activeToggleManual,
              ]}
            ...
            >
              ...
              <Text
                style={[
                  styles.toggleText,
                  mode === "manual" && styles.activeToggleTextManual,
                ]}
              >
                Creación Manual
              </Text>
            ...
            <View style={styles.aiCard}>
              ...
              <TouchableOpacity
                style={[
                  ...
                  { marginTop: 24, backgroundColor: "#94A3B8" + "80" },
                ]}
        ...
        <SetRepSelectionModal
          ...
          initialSets={
            editingExerciseId
              ? exercises.find((e) => e.id === editingExerciseId)?.sets.length
              : 3
          }
          initialReps={
            editingExerciseId
              ? exercises.find((e) => e.id === editingExerciseId)?.sets[0]?.reps
              : 10
          }
          confirmButtonText={
            editingExerciseId ? "Update Exercise" : "Add to Workout"
          }
        />
          ...
          <View style={{ flexDirection: "row", gap: 12 }}>
            {initialRoutine && (
              ...
              >
                ...
                <Text style={[styles.primaryButtonText, { color: "#EF4444" }]}>
                  Delete
                </Text>
              </TouchableOpacity>
            )}
            {mode === "ai" ? (
              ...
              <TouchableOpacity
                style={[styles.primaryButton, { flex: initialRoutine ? 2 : 1 }]}
                onPress={handleSave}
              >
