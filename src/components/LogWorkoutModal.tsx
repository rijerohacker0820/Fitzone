        ...
        <View style={{ flex: 1, backgroundColor: colors.background }}>
          ...
          >
                ...
                {ex.sets.map((set, setIdx) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <TouchableOpacity
                        onPress={() =>
                          handleUpdateSet(exIdx, setIdx, "status", "completed")
                        }
                        style={{
                          width: 32,
                          height: 32,
                          ...
                          borderWidth: 1,
                          borderColor:
                            set.status === "completed" ? "#22C55E" : "#E2E8F0",
                          alignItems: "center",
                      ...
                      >
                        <Check
                          color={
                            set.status === "completed" ? "#FFF" : "#94A3B8"
                          }
                          size={16}
                        />
                      </TouchableOpacity>
                      ...
                      <TouchableOpacity
                        onPress={() =>
                          handleUpdateSet(exIdx, setIdx, "status", "partial")
                        }
                        style={{
                          width: 32,
                          height: 32,
                          ...
                          borderWidth: 1,
                          borderColor:
                            set.status === "partial" ? "#F59E0B" : "#E2E8F0",
                          alignItems: "center",
                          justifyContent: "center",
                        }}
                      >
                      ...
                      <TouchableOpacity
                        onPress={() =>
                          handleUpdateSet(exIdx, setIdx, "status", "failed")
                        }
                        style={{
                          width: 32,
                          height: 32,
                          borderRadius: 16,
                          backgroundColor:
                            set.status === "failed" ? "#EF4444" : "transparent",
                          borderWidth: 1,
                          borderColor:
                            set.status === "failed" ? "#EF4444" : "#E2E8F0",
                          alignItems: "center",
                          justifyContent: "center",
                        }}
                      >
                        <X
                          color={set.status === "failed" ? "#FFF" : "#94A3B8"}
                          size={16}
                        />
                      </TouchableOpacity>
                    </View>
                    ...
                    >
                      <TextInput
                        ...
                        onChangeText={(val) =>
                          handleUpdateSet(exIdx, setIdx, "weight", val)
                        }
                        placeholder="KG"
                      />
                      <TextInput
                        ...
                        onChangeText={(val) =>
                          handleUpdateSet(exIdx, setIdx, "reps", val)
                        }
                        placeholder="REPS"
                      />
                    </View>
            ...
            >
              ...
              <Text
                style={{ color: "#94A3B8", fontSize: 18, fontWeight: "600" }}
              >
                Agregar Ejercicio
              </Text>
            </TouchableOpacity>
                  ...
                  {SENSATIONS.map((s) => (
                    <TouchableOpacity
                      ...
                      style={{
                        ...
                        borderRadius: 10,
                        backgroundColor:
                          sensation === s.label ? colors.primary : "#F1F5F9",
                        borderWidth: 1,
                        borderColor:
                          sensation === s.label
                            ? colors.primary
                    ...
                    >
                      <Text
                        style={{
                          color: sensation === s.label ? "#FFF" : "#64748B",
                          fontWeight: "600",
                        }}
                      >
                        {s.label}
            ...
            >
              <Star
                size={20}
                color={saveAsRoutine ? colors.primary : colors.textSecondary}
                fill={saveAsRoutine ? colors.primary : "transparent"}
              />
              <Text
                style={{
                  marginLeft: 10,
                  color: saveAsRoutine ? colors.primary : colors.text,
                  fontWeight: "600",
                }}
              >
                Guardar como Rutina
