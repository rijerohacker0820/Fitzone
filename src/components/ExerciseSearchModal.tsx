...
import { View, Text, Modal, TouchableOpacity, TextInput, FlatList, StyleSheet, ScrollView } from 'react-native';
...
export default function ExerciseSearchModal({ visible, onClose, onSelect, addedExercises, onRemove }: Props) {
            ...
            <View style={[styles.container, { backgroundColor: colors.background }]}>
                ...
                {addedExercises.length > 0 && (
                    <View style={{ marginBottom: 20 }}>
                        <Text style={{ color: colors.textSecondary, fontSize: 14, fontWeight: '600', marginBottom: 12, letterSpacing: 0.5 }}>SELECTED EXERCISES ({addedExercises.length})</Text>
                            ...
                            <View style={{ flexDirection: 'row', gap: 12 }}>
                                {addedExercises.map((ex) => (
                                    <View key={ex.id} style={{
                                        ...
                                        <Text style={{ color: colors.primary, fontWeight: '600', marginRight: 8 }}>{ex.name}</Text>
                ...
                {/* Search Bar */}
                <View style={[styles.searchBar, { backgroundColor: colors.card, borderColor: '#E2E8F0' }]}>
