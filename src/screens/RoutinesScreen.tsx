...
const LOGO_IMG = require("../assets/Imagotipo.png");
...
export default function RoutinesScreen() {
  ...
  // Additional state
  const [detailWorkout, setDetailWorkout] = useState<WorkoutRoutine | null>(
    null,
  ); // Kept this as it's used later
  ...
  const [routineToShare, setRoutineToShare] = useState<WorkoutRoutine | null>(
    null,
  );
  ...
  const renderRoutine = ({ item }: { item: WorkoutRoutine }) => {
    ...
    return (
      <View
        style={{
          backgroundColor: isCompletedToday ? "#22C55E15" : colors.card,
          padding: 16,
          borderRadius: 20,
          marginBottom: 16,
          borderWidth: 1.5,
          borderColor: isCompletedToday ? "#22C55E30" : "transparent",
          shadowColor: "#000",
      ...
      >
        <TouchableOpacity onPress={() => handleShowDetail(item)}>
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              >
                <Text
                  style={{
                    color: isCompletedToday ? "#22C55E" : colors.text,
                    fontSize: 18,
                    fontWeight: "bold",
                  }}
                >
            ...
            >
              {item.tags.map((tag, idx) => (
                <View
                  key={idx}
                  style={{
                    backgroundColor: isCompletedToday ? "#22C55E20" : colors.background,
                    paddingHorizontal: 8,
                    paddingVertical: 4,
                    borderRadius: 6,
                    marginRight: 6,
                ...
                >
                  <Text
                    style={{
                      color: isCompletedToday ? "#22C55E" : colors.textSecondary,
                      fontSize: 11,
                      fontWeight: "600",
                    }}
                  >
          ...
          <View
            style={{
              backgroundColor: isCompletedToday ? "#22C55E10" : colors.background,
              borderRadius: 10,
              padding: 10,
              borderWidth: 1,
              borderColor: isCompletedToday ? "#22C55E30" : "transparent",
          ...
          >
            ...
            >
              {item.exercises.length} {t("exercises").toLowerCase()}{" "}
              <Text
                style={{
                  color: isCompletedToday ? "#86EFAC" : "#CBD5E1",
                  marginHorizontal: 4,
                }}
              >
                |
              ...
              <Text
                style={{
                  fontWeight: "400",
                  fontSize: 12,
                  color: isCompletedToday ? "#166534" : "#94A3B8",
                }}
              >
                {item.exercises
                  .slice(0, 3)
        ...
        >
          ...
          <TouchableOpacity
            style={{
              backgroundColor: isCompletedToday ? "#22C55E" : colors.primary,
              flexDirection: "row",
              alignItems: "center",
          ...
          >
            ...
            >
              {isCompletedToday ? t("doAgain") : t("start")}
            </Text>
    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          style={{
            backgroundColor: filterFavorites ? "#FEF3C7" : colors.background,
            width: 48,
            height: 48,
            borderRadius: 24,
            alignItems: "center",
            justifyContent: "center",
            borderWidth: filterFavorites ? 1 : 1,
            borderColor: filterFavorites ? "#F59E0B" : "transparent",
          }}
        >
          <Star
            color={filterFavorites ? "#F59E0B" : colors.textSecondary}
            fill={filterFavorites ? "#F59E0B" : "transparent"}
            size={24}
          />
        </TouchableOpacity>
      </View>
      ...
      >
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              onPress={() =>
                routineToShare && handleNativeShare(routineToShare)
              }
              style={{
                flexDirection: "row",
                alignItems: "center",
                ...
                >
                  <View
                    style={{
                      ...
                      height: 36,
                      borderRadius: 12,
                      backgroundColor: squad.color || "#EFF6FF",
                      alignItems: "center",
                      justifyContent: "center",
                      marginRight: 12,
                    }}
