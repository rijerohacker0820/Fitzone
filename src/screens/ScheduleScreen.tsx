...
export default function ScheduleScreen() {
  ...
  const renderHistoryList = () => {
    const selectedLogs = workoutLogs.filter(
      (log) =>
          ...
          >
            ...
            <Text
              style={[
                ...
                {
                  color:
                    activeTab === "History" ? "#FFF" : colors.textSecondary,
                },
              ]}
            >
              {t("history")}
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.dayCard,
                    {
                      ...
                      width: day === "SUN" ? width - 40 : (width - 60) / 2,
                    },
                  ]}
                >
                  <View
          ...
          >
            <View style={styles.modalHeader}>
              <Text style={[styles.modalTitle, { color: colors.text }]}>
                {t("assignRoutineTo").replace("{day}", selectedDay || "")}
              </Text>
            ...
            >
              <TouchableOpacity
                ...
                style={[
                  ...
                  {
                    backgroundColor: colors.card,
                    borderColor: weeklyPlan[selectedDay!]
                      ? "transparent"
                      : colors.primary,
                  ...
                  >
                    <View style={styles.optionContent}>
                      ...
                      >
                        ...
                        <Text
                          style={[styles.exerciseCount, { color: colors.text }]}
                        >
